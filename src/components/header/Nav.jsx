...
const Nav = ({ containerStyles, linkStyles, links: customLinks }) => {
  ...
  const defaultLinks = [
    ...
    { path: "about", name: t("about"), offset: 40, type: "scroll" },
    { path: "plan", name: t("plan"), offset: -10, type: "scroll" },
    { path: "location", name: t("location"), offset: -760, type: "scroll" },
    { path: "facilities", name: t("facilities"), offset: -310, type: "scroll" },
